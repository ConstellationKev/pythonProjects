...
characters = ["Clay", "Tsunami", "Glory", "Jambu", "Kinkajou", "Starflight", "Mastermind", "Sunny", "Deathbringer", "Moonwatcher", "Queen Batttlewinner", "Greatness", "Queen Morheen", "Queen Ruby", "Queen Scarlet", "Queen Thorn", "Queen Blaze", "Queen BURN", "Queen Blister", "Sixclaws", "Turtle", "Anemone", "Stonemover", "Morrowseer", "Peril", "Scavenger", "Smolder", "Queen Glacier", "Kestrel", "Dune", "Webs", "Fatespeaker", "Flame", "Viper", "Dragonbite Viper", "Squid", "Orche"]
divider = "-----------------------------------"
print("This is the Random Wings Of Fire Battle Generator!")
sleep(2)
print(divider)
while True:
